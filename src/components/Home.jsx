...
const Home = () => {
  ...
  return (
    <div
        ...
        >
          <div className="w-full max-w-7xl bg-[url('/images/profile.png')] bg-center bg-contain bg-no-repeat bg-fixed bg-blend-overlay bg-zinc-900/85 rounded-4xl shadow-9xl p-6 md:p-10 lg:p-4 flex flex-col justify-center items-center">
          ...
          <section className="w-full flex flex-col lg:flex-row justify-center relative items-center gap-10">
            ...
            >
              <div className="px-10 md:px-16 py-10 md:py-20 flex flex-col gap-4 justify-center items-start">
