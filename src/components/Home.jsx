...
const Home = () => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-7xl bg-[url('/images/profile.png')] bg-center bg-cover bg-no-repeat bg-scroll sm:bg-fixed bg-blend-overlay bg-zinc-900/85 rounded-3xl shadow-2xl px-4 py-8 md:p-10 lg:p-4 flex flex-col justify-center items-center">
